...
public class SqliteTableDatabase extends SQLiteOpenHelper {
    ...
    public void add_info(SqliteTableDatabase p,String name,String roll,String sem,String pass)
    {
        ...
        write_new.put(SqliteTable.SqliteTableInfo.Student_Roll,roll);
        write_new.put(SqliteTable.SqliteTableInfo.Student_Sem,sem);
    ...
    public Cursor login_info(SqliteTableDatabase p)
    {
        ...
        String[] col = {SqliteTable.SqliteTableInfo.Student_Name, SqliteTable.SqliteTableInfo.Student_Roll, SqliteTable.SqliteTableInfo.Student_Sem, SqliteTable.SqliteTableInfo.Student_Pass};
    ...
    public void user_update(SqliteTableDatabase p,String name,String pass,String newusername)
    {
        SQLiteDatabase write = p.getWritableDatabase();
        ...
        values.put(SqliteTable.SqliteTableInfo.Student_Name,newusername);
        write.update(SqliteTable.SqliteTableInfo.Name_Of_Table,values,l_sel,args);
